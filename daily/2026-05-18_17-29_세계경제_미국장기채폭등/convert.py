...
async def main():
    ...
    headless_shell = Path("/opt/pw-browsers/chromium_headless_shell-1194/chrome-linux/headless_shell")
    launch_kwargs = {}
    if headless_shell.exists():
        launch_kwargs["executable_path"] = str(headless_shell)
